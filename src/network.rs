...
const TESTNET_BITCOIN_ID: [u8; 32] = [
    0xd0, 0x28, 0x95, 0x01, 0xe1, 0x1b, 0xcc, 0x3a, 0x1b, 0x8f, 0xac, 0x4e, 0x90, 0xc6, 0x17, 0x2f,
    0x46, 0x63, 0x5a, 0x35, 0x91, 0xfc, 0xd7, 0x2e, 0x72, 0xbd, 0xd7, 0x59, 0x83, 0x7c, 0x0b, 0xe8,
];

const TESTNET_GENESIS_HASH: [u8; 32] = [
    0xfb, 0xdb, 0x4a, 0x01, 0x4b, 0x0e, 0x43, 0xf8, 0xc7, 0xad, 0x23, 0xb8, 0xde, 0xde, 0x5b, 0x7e,
    0x5c, 0xf7, 0x04, 0x46, 0x68, 0x5b, 0x16, 0xaa, 0x88, 0x9c, 0x8c, 0xac, 0x48, 0x4c, 0x8d, 0x40,
];
...
impl Network {
    ...
    ///
    /// The above command prints the hex string in **reversed byte order**!
    /// This matches the behavior of [`fmt::Display`] implementations of [`elements::AssetId`].
    /// The raw byte Rust array must be written in **original order**!
    ...
    ///
    /// The above command prints the hex string in **reversed byte order**!
    /// This matches the behavior of [`fmt::Display`] implementations of [`elements::BlockHash`].
    /// The raw byte Rust array must be written in **original order**!
